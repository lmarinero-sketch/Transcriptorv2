  ...
  return (
    <nav className="navbar glass-panel sticky top-0 z-50 transition-all duration-300">
      <div className="max-w-7xl mx-auto flex items-center justify-between h-16 px-4">
        <Link href="/" className="flex items-center gap-2 text-sanatorio-primary hover:text-sanatorio-secondary transition-colors font-bold font-display text-lg">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <Link href="/record" className="btn-primary" style={{ padding: "8px 16px", fontSize: "0.85rem", gap: "6px" }}>
            <span>⚡</span>
            Nueva Reunión
          </Link>
